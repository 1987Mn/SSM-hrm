...
<form action="${ctx}/jobaddsave" id="jobForm" method="post">
    ...
    <td>
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">职位名：<input name="name" value="${requestScope.job.name}" id="name" size="20" /></td>
		    			<td class="font3 fftd">职位描述：<input name="remark" value="${requestScope.job.remark}" id="remark" size="20" /></td>
		    		</tr>
		    	</table>
		    </td></tr>
			<tr><td align="left" class="fftd"><input type="submit" value="保存">&nbsp;
				&nbsp;<input type="reset" class="quxiao" id="quxiao" value="取消 "></td></tr>
		  </table>
	</td>
  </tr>
</table>
