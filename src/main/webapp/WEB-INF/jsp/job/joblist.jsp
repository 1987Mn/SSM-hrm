	...
	$(function(){
		...
		$("#delete").click(function(){
			...
			if(checkedBoxs.length < 1){
				...
				$("#jobform").attr("action", "${ctx}/jobdelete");
				$("#jobform").submit();
			}
		})

		$("#query").click(function(){
			$("#jobform").attr("action", "${ctx}/joblist");
			$("#jobform").submit();
		})
							...
							<td class="fftd">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td class="font3">
											职位名：
											<input type="text" name="name" value="${requestScope.job.name}" />&nbsp;&nbsp;
											职位描述：
											<input type="text" name="remark" value="${requestScope.job.remark}" />
